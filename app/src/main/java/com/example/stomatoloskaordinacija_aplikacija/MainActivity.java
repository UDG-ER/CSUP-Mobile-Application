...
if(usernameBaza.equals(username.getText().toString()) && passwordBaza.equals(password.getText().toString())){
    ...
    startActivity(intent);
        ...
        protected void onPostExecute(Void Result){
            if(brojac==1){
            Toast.makeText(MainActivity.this, "Dobrodošli!", Toast.LENGTH_SHORT).show();
}else{
                Toast.makeText(MainActivity.this, "Pogrešan unos! Pokusajte ponovo...", Toast.LENGTH_SHORT).show();
            }
